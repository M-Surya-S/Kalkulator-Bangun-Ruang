...
btn_limas5 = buat_tombol("Limas Segi Lima")
btn_limas6 = buat_tombol("Limas Segi Enam")
...
layout_hor6 = buat_layout(btn_limas5)
layout_hor6.addWidget(btn_limas6)
...
layout_ver.addLayout(layout_hor6)
...
def kubus():
    ...
    def total():
        try:
            ...
            keliling.setText(f"Keliling               : {k} m dan {k:.2f} cm")
...
def limas_segilima():
    windbar = QMainWindow(window)
    windbar.setGeometry(400, 50, 500, 650)
    windbar.setWindowTitle("Limas Segi Lima")
    ...
    def total():
        try:
            ...
            v = 5*a*a/4*math.cot(22/7/5)*tl
            lupe = 5*a*a/4*math.cot(22/7/5)+1/2*a*ts
...
def limas_segienam():
    windbar = QMainWindow(window)
    windbar.setGeometry(400, 50, 500, 650)
    windbar.setWindowTitle("Limas Segi Enam")
...
btn_limas5.clicked.connect(limas_segilima)
btn_limas6.clicked.connect(limas_segienam)
